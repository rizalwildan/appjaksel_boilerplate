...
class RuleHari extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->model('RuleHari_model', 'RuleHariModel');
        $this->_init();
    }
    ...
    public function index() {
        if (!$this->ion_auth->logged_in()) {
            ...
            $this->data['hari'] = $this->RuleHariModel->find()->get()->result_array();

            $this->load->view('page/hari/index', $this->data);
        }
    }
    ...
    public function edit($id) {
        ...
        $this->load->view('page/hari/edit', $this->data);
    }
}